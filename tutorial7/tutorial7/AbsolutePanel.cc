...
AbsolutePanel::AbsolutePanel(Rectangle dimensions, const std::string& id): Panel(dimensions, id) {}
...
void AbsolutePanel::draw(Display *display, Window win, GC gc, const Rectangle& box){
    XDrawRectangle(display, win, gc, dimensions.x, dimensions.y, dimensions.width, dimensions.height);
