...
TextArea::TextArea(int x, int y, int width, int height, const std::string& id, const std::string& label): dimensions{x, y, width, height}, id(id), text(label), fill(RGB(0,0,0)), border(RGB(0,0,0)){}
TextArea::TextArea(Rectangle rect, const std::string& id, const std::string& label): dimensions(rect), id(id), text(label), fill(RGB(0,0,0)), border(RGB(0,0,0)){}
